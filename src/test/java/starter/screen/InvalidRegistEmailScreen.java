...
public class InvalidRegistEmailScreen extends BasePageObject {
    ...
    @Step
    public String getErrorMessageOnEmailField() {return waitUntilVisible(errorMessageOnEmailField()).getText();
    }
