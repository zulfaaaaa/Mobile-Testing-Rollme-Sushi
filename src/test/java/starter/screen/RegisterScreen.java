...
public class RegisterScreen extends BasePageObject {
    ...
    private By successMessage() { return AppiumBy.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.TextView"); }
    ...
    @Step
    public String getSuccessMessage() {return waitUntilVisible(successMessage()).getText();
    }
